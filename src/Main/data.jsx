export const dataExperience = {
    ...
    info: {
        0: {
            ...
            first: "During this internship I worked out with searchers of ENGEES  (École Nationale du Génie de l'Eau et de l'Environnement de Strasbourg)  school ,",
            second: "in order to build up a web site for the  OFB  (L'Office français de la biodiversité ). ",
        ...
        1: {
            ...
            first: "Throughout  this internship, I worked out with searchers of l3i  (Laboratoire Informatique, Image, Interaction) ",
